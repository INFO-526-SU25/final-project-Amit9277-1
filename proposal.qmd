...
| Data Cleanup | Cat | In-Progress | 2025-06-19 | High Priority | Clean the dataset (handle missing values, outliers, formatting). Consult Amit for any major decisions on data handling. |
| Creating New Variables | Amit | In-Progress | 2025-06-19 | Moderate Priority | Create derived variables for analysis based on research questions. Share variable definitions with Cat for feedback. |
...
| Create Interactive PowerPoint | Amit | To-Do | 2025-06-27 | Moderate Priority | Design an interactive PowerPoint presentation summarizing findings. Incorporate feedback from Cat on layout and content. |
| Film Presentation | Cat & Amit | To-Do | 2025-06-29 | Low Priority | Jointly record the video presentation. Cat handles setup; Amit ensures script alignment with slides. |
| Edit Presentation | Amit | To-Do | 2025-07-01 | Low Priority | Edit the video for clarity and polish. Share with Cat for final approval before submission. |
| Project Website | Amit | To-Do | 2025-07-02 | Low Priority | Publish project website to GitHub with all the project components. |
| Final Project Submission | Cat & Amit | To-Do | 2025-07-02 | Low Priority | Make any last minute changes and submit the final project with mutual sign-off from both the team members. |
