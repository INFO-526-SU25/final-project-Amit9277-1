...
| Write-Up of Analysis and Code | Cat | In-Progress | 2025-06-25 | Moderate Priority | Write explanations for code and graphs, detailing methodology and findings. Amit reviews for clarity and accuracy. |
| Create Interactive PowerPoint | Amit | In-Progress | 2025-06-27 | Moderate Priority | Design an interactive PowerPoint presentation summarizing findings. Incorporate feedback from Cat on layout and content. |
...
| Project Website | Amit | In-Progress | 2025-07-02 | Low Priority | Publish project website to GitHub with all the project components. |
